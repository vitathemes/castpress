        ...
        <div class="c-single__podcast-audio">
            ...
            <?php 
                if ( 'episodes' == get_post_type() ){
                     ...
                     echo sprintf("<div class='c-episode__player c-episode__player--button'><button class='c-btn c-btn--play js-btn--play' aria-label='%s' aria-controls='%s' >%s</button></div>" , esc_html__( 'Play button' , 'castpress' ) , esc_attr( 'play-button' ) , esc_html__( 'Play', 'castpress' ));
