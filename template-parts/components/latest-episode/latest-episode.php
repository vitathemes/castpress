...
<article id="post-<?php the_ID(); ?>" <?php post_class('c-single c-single--latest-episode'); ?>>
    ...
    <header class="c-single__header">
        <?php the_title( '<h1 class="c-single__title c-single__title--sm c-main__entry-title"><a class="u-link--secondary h1 u-heading-1-line-height--bg" href="' . esc_url( get_permalink() ) . '" rel="bookmark">', '</a></h1>' );?>
