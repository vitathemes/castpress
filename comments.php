...
<div id="comments" class="comments-area">
    ...
    <?php
		...
		$comments_args = array(
			...
			'fields' => array(
				//Author field
				'author' => '<h4 class="comment-form-author u-heading-4-line-height--bg">'. __( 'Name*', 'castpress' ).'<br /><input type="text" id="author" name="author" aria-required="true" /></h4>',
				//Email Field
				'email' => '<h4 class="comment-form-email u-heading-4-line-height--bg">'. __( 'Email*', 'castpress' ).'<br /><input type="email" id="email" name="email" /></h4>',
				//URL Field
				'url' => '<h4 class="comment-form-url u-heading-4-line-height--bg">'. __( 'Website', 'castpress' ).'<br /><input type="url" id="url" name="url" /></h4>',
				//Cookies
				'cookies' => '<div class="c-comment__cookie"><input type="checkbox" name="wp-comment-cookies-consent" required><span class="h6 h6--regular u-line-height--sm u-font--regular c-comments__cookie">' . __(' Save my name, email, and website in this browser for the next time I comment', 'castpress' ) .'</span></div>',
			),
			...
			'comment_field' => '<h4 class="comment-form-comment u-heading-4-line-height--bg">'. __( 'Comment*', 'castpress' ).'<br /><textarea id="comment" name="comment" aria-required="true" ></textarea></h4>',
