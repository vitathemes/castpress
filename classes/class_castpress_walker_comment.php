                ...
                <div class="comment-header">
                    <?php
                        if (get_comment_author_url($comment) != "") {
	                        printf('<div class="comment-author h5--secondary u-heading-5-line-height--sm"><a href="%s">%s</a></div>', esc_html(esc_url(get_comment_author_url($comment))), esc_html(esc_html(get_comment_author($comment))));
                        } else {
	                        printf('<div class="comment-author h5--secondary u-heading-5-line-height--sm">%s</div>', esc_html(get_comment_author($comment)));
                        }
	                    ?>

                    <div class="time h5--secondary u-heading-5-line-height--sm">
