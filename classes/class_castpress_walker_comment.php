                ...
                <div class="comment-header">
                    <?php
                        if (get_comment_author_url($comment) != "") {
	                        printf('<h5 class="comment-author h5--regular u-heading-5-line-height--sm"><a href="%s">%s</a></h5>', esc_html(esc_url(get_comment_author_url($comment))), esc_html(esc_html(get_comment_author($comment))));
                        } else {
	                        printf('<h5 class="comment-author h5--regular u-heading-5-line-height--sm">%s</h5>', esc_html(get_comment_author($comment)));
                        }
	                    ?>
                    ...
                    <div class="time">
						...
						<h5 class="comment-date h5--regular u-heading-5-line-height--sm">
                            <?php
